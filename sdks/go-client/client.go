...
const (
	...
	// maxErrorBodyBytes caps how much of a failed response this package retains
	// on an APIError. A misconfigured proxy in front of the server can answer
	// with an arbitrarily large HTML page.
